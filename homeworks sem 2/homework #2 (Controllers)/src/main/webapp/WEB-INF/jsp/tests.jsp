...
<html>
  ...
  <body>
    ...
    <div style="border:3px double black;margin:100px; padding:30px; word-break: break-all; text-align: center">
      ${viewVariable}
      ...
      <table border="2">
        ...
        <c:forEach var="group" items="${allHeaders}">
          <tr>
            <th>${group.getName()}</th>
            <th>${group.getValue()}</th>
          </tr>
        </c:forEach>
      </table>
    </div>
